...
public class RearrangeLinkedList {
    ...
    public static LinkedList rearrangeLinkedList(LinkedList head, int k) {
        ...
        while (node != null) {
            ...
            if (node.value < k) {
                LinkedListPair smallerList = buildLinkedList(smallerListHead, smallerListTail, node);
                smallerListHead = smallerList.head;
                smallerListTail = smallerList.tail;
            } else if (node.value > k) {
                LinkedListPair greaterList = buildLinkedList(greaterListHead, greaterListTail, node);
                greaterListHead = greaterList.head;
                greaterListTail = greaterList.tail;
            } else {
                LinkedListPair equalList = buildLinkedList(equalListHead, equalListTail, node);
    ...
    public static LinkedListPair buildLinkedList(LinkedList head, LinkedList tail, LinkedList node) {
