...
public class AirportConnections {
    ...
    public static int airportConnections(
        ...
        List<AirportNode> unreachableAirportNodes = getUnreachableNodes(airportGraph, airports, startingAirport);
    ...
    private static void depthFirstAddUnreachableConnections(Map<String, AirportNode> airportGraph, String airport, List<String> unreachableConnections, Set<String> visitedAirports) {
    ...
    private static List<AirportNode> getUnreachableNodes(Map<String, AirportNode> airportGraph, List<String> airports, String startingAirport) {
        Set<String> visitedAirports = new HashSet<>();
